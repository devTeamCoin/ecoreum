Contributing to ECRM Core
============================

The ECRM Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ECRM Core project, and is not to be
confused with overall ECRM Network Protocol consensus changes.

Whether a pull request is merged into ECRM Core rests with the project merge
...
Patches that change ECRM consensus rules are considerably more involved than
...
Where a patch set proposes to change the ECRM consensus, it must have been
...
The project leader is the release manager for each ECRM Core release.
