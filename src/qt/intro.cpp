...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ECRM Core"),
     ...
     * override -datadir in the ecoreumcoin.conf file in the default data directory
     * (to be consistent with ecoreumcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
