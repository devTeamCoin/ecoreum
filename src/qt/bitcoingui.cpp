                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ECRM Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ECRM address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ecoreumcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zECRM"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ECRM Core"), this);
    aboutAction->setStatusTip(tr("Show information about ECRM Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ECRM"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ECRM addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ECRM addresses"));
    ...
    openAction->setStatusTip(tr("Open a ECRM: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ECRM Core help message to get a list with possible ECRM command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ECRM Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ECRM network", "", count));
}
...
{
    QString strTitle = tr("ECRM Core"); // default title
