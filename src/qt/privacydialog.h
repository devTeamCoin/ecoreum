...
public:
    ...
    void setZEcoreumControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzECRM_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzECRM_clicked();
    void on_pushButtonZEcoreumControl_clicked();
