...
/** Utility functions used by the ECRM Qt UI.
 */
namespace GUIUtil
{
...
// Render ECRM addresses in monospace font
...
// Parse "ecoreumcoin:" URI into recipient object, return true on successful parsing
