                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Ecoreum from zEcoreum"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zEcoreum"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zEcoreum));
