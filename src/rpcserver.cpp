...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Ecoreum features */
        {"ecoreumcoin", "masternode", &masternode, true, true, false},
        {"ecoreumcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"ecoreumcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ecoreumcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ecoreumcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ecoreumcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"ecoreumcoin", "startmasternode", &startmasternode, true, true, false},
        {"ecoreumcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ecoreumcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ecoreumcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ecoreumcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ecoreumcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ecoreumcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ecoreumcoin", "mnbudget", &mnbudget, true, true, false},
        {"ecoreumcoin", "preparebudget", &preparebudget, true, true, false},
        {"ecoreumcoin", "submitbudget", &submitbudget, true, true, false},
        {"ecoreumcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ecoreumcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ecoreumcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ecoreumcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ecoreumcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ecoreumcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ecoreumcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ecoreumcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"ecoreumcoin", "mnsync", &mnsync, true, true, false},
        {"ecoreumcoin", "spork", &spork, true, true, false},
        {"ecoreumcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ecoreumcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ecoreumcoind, or the -server option to ecoreumcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ecoreumcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:32743/\n";
}
