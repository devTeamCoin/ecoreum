...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ecoreum Core ecoreumcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ecoreumcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ecoreumcoin transaction") + "\n" +
                               "  ecoreumcoin-tx [options] -create [commands]   " + _("Create hex-encoded ecoreumcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ecoreumcoin transaction
