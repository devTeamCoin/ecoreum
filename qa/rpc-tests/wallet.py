...
#   c) node1 mines 32 blocks, so now node 0 has 60001ecoreumcoin, node 1 has 4250ecoreumcoin, node2 has none.
#   d) node0 sends 601 ecoreumcoin to node2, in two transactions (301 ecoreumcoin, then 300 ecoreumcoin).
