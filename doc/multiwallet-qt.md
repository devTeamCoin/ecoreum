...
In order to support loading of multiple wallets in ecoreumcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ecoreumcoin.cpp.
...
Changes to ecoreumcoin.cpp
----------------------
ecoreumcoin.cpp is the entry point into ecoreumcoin-qt, and as such, will require some minor modifications to provide hooks for
